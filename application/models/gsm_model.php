<?php
	...
	class GSM_Model extends CI_Model {
		...
		function get_all_users ($sorting = '') {
			switch ($sorting) {
				case 'user_id/ASC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY id ASC');
					break;
				case 'user_id/DESC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY id DESC');
					break;
				case 'name/ASC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY first_name ASC, last_name ASC');
					break;
				case 'name/DESC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY first_name DESC, last_name DESC');
					break;
				case 'payment_date/ASC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY payment_date ASC');
					break;
				case 'payment_date/DESC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY payment_date DESC');
					break;
				case 'payment_valid_until/ASC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY payment_valid_until ASC');
					break;
				case 'payment_valid_until/DESC':
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY payment_valid_until DESC');
					break;
				default:
					$query = $this->db->query ('SELECT users.id, users.first_name, users.last_name, users.email, final.id AS payment_id, payment_date, final.valid_until AS payment_valid_until FROM users LEFT JOIN ( SELECT * FROM ( SELECT payments.id, payments.user_id, payments.date AS payment_date, payments.valid_until FROM payments ORDER BY payments.valid_until DESC ) AS p GROUP BY p.user_id ) AS final ON final.user_id = users.id ORDER BY id');
					break;
